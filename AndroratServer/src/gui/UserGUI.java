...
public class UserGUI extends JFrame implements WindowListener {
	...
	public UserGUI(String imei, GUI gui) {
		setIconImage(
				Toolkit.getDefaultToolkit().getImage(UserGUI.class.getResource("/gui/res/androrat_logo_32pix.png")));
		this.imei = imei;
		this.gui = gui;
	...
	public void updatePreference(String ip, int port, boolean wait, ArrayList<String> phones, ArrayList<String> sms,
			ArrayList<String> kw) {
	...
	public void fireSaveConnectConfigurations(String ip, int port, boolean wait, ArrayList<String> phones,
	...
	public void fireTakePicture1() {
		gui.fireTakePicture1(imei);
	}
	...
	public void fireButtonCloseTab() {
		...
		if (panel == homePanel) {
			JOptionPane.showMessageDialog(this, "You can't close the home tab !", "Forbiden action",
