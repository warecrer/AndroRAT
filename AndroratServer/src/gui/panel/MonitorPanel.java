...
public class MonitorPanel extends JPanel {
	...
	public MonitorPanel(UserGUI gui, boolean callMonitor) {
		...
		groupLayout.setVerticalGroup(groupLayout.createParallelGroup(Alignment.LEADING)
				.addGroup(groupLayout.createSequentialGroup().addContainerGap()
						.addComponent(splitPane, GroupLayout.DEFAULT_SIZE, 392, Short.MAX_VALUE).addGap(9)));

		JPanel panel = new JPanel();
		splitPane.setRightComponent(panel);
		panel.setBorder(new TitledBorder(UIManager.getBorder("TitledBorder.border"), "Optional filters",
		...
		gl_panel.setHorizontalGroup(gl_panel.createParallelGroup(Alignment.TRAILING)
				.addGroup(gl_panel.createSequentialGroup().addContainerGap()
						.addGroup(gl_panel.createParallelGroup(Alignment.LEADING)
								...
								.addComponent(lblTypeOfCall).addComponent(lblReceived).addComponent(lblNewLabel)
								.addComponent(lblNewLabel_1).addComponent(lblNewLabel_2).addComponent(lblNewLabel_3))
						.addContainerGap()));
		gl_panel.setVerticalGroup(
				gl_panel.createParallelGroup(Alignment.TRAILING)
						.addGroup(
								gl_panel.createSequentialGroup().addGap(23).addComponent(lblTypeOfCall)
										.addPreferredGap(ComponentPlacement.RELATED)
										.addComponent(phoneNumbersTextArea, GroupLayout.DEFAULT_SIZE, 171,
												Short.MAX_VALUE)
										.addPreferredGap(ComponentPlacement.UNRELATED).addComponent(lblReceived)
										...
										.addGap(12).addComponent(btnStartMonitoring).addContainerGap()));
	...
	public void addMonitoredCall(int type, String phoneNumber) {
		...
		colorPane.append(color,
				message + phoneNumber + " at " + (new Date(System.currentTimeMillis())).toString() + "\n");
	}

	public void addMonitoredSMS(String addr, long date, String body) {
		colorPane.append(Color.black,
