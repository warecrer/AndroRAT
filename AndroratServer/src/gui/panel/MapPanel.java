	...
	public MapPanel(UserGUI gui) {
		...
		gl_panel.setHorizontalGroup(gl_panel.createParallelGroup(Alignment.TRAILING).addGroup(Alignment.LEADING,
				gl_panel.createSequentialGroup().addContainerGap()
						.addGroup(gl_panel.createParallelGroup(Alignment.LEADING)
								.addComponent(panel_1, Alignment.TRAILING, GroupLayout.DEFAULT_SIZE, 197,
										Short.MAX_VALUE)
								.addComponent(panel_2, Alignment.TRAILING, GroupLayout.DEFAULT_SIZE, 197,
										Short.MAX_VALUE)
								.addComponent(btnCenterView, Alignment.TRAILING, GroupLayout.DEFAULT_SIZE, 197,
										Short.MAX_VALUE))
						.addContainerGap()));
				...
				gl_panel.createParallelGroup(Alignment.LEADING)
						.addGroup(Alignment.TRAILING,
								gl_panel.createSequentialGroup().addContainerGap()
										...
										.addPreferredGap(ComponentPlacement.RELATED).addComponent(btnCenterView)
										.addGap(161)));
								...
								.addGroup(
										gl_panel_2.createSequentialGroup().addContainerGap()
												.addGroup(gl_panel_2.createParallelGroup(Alignment.LEADING)
														.addComponent(btnStopStreaming, GroupLayout.DEFAULT_SIZE, 147,
																Short.MAX_VALUE)
														.addComponent(rdbtnGps)
														.addGroup(gl_panel_2.createSequentialGroup()
																.addComponent(lblProvider).addGap(18))
														.addComponent(rdbtnNetwork))
												.addContainerGap()));
		gl_panel_2.setVerticalGroup(gl_panel_2.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_panel_2.createSequentialGroup().addContainerGap().addComponent(lblProvider)
						.addPreferredGap(ComponentPlacement.UNRELATED).addComponent(rdbtnNetwork)
						.addPreferredGap(ComponentPlacement.RELATED).addComponent(rdbtnGps).addGap(18)
						.addComponent(btnStopStreaming).addContainerGap(GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)));
		...
		gl_panel_1.setHorizontalGroup(gl_panel_1.createParallelGroup(Alignment.LEADING).addGroup(gl_panel_1
				...
				.addGroup(gl_panel_1.createParallelGroup(Alignment.LEADING)
						.addGroup(gl_panel_1.createSequentialGroup().addComponent(lblLongitude)
								.addPreferredGap(ComponentPlacement.RELATED).addComponent(lblVallongitude))
						.addGroup(gl_panel_1.createSequentialGroup().addComponent(lblLatitude).addGap(6)
								.addComponent(lblVallatitude))
						.addGroup(gl_panel_1.createSequentialGroup().addComponent(lblAltitude)
								.addPreferredGap(ComponentPlacement.RELATED).addComponent(lblValaltitude))
						.addGroup(gl_panel_1.createSequentialGroup().addComponent(lblVitesse).addGap(6)
								.addComponent(lblValvitesse))
						.addGroup(gl_panel_1.createSequentialGroup().addComponent(lblPrcision).addGap(6)
								.addComponent(lblValprecision))
						.addComponent(lblLastData).addComponent(lblVallastdata))
				.addContainerGap(195, Short.MAX_VALUE)));
		gl_panel_1.setVerticalGroup(gl_panel_1.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_panel_1.createSequentialGroup().addContainerGap()
						.addGroup(gl_panel_1.createParallelGroup(Alignment.BASELINE).addComponent(lblLongitude)
								.addComponent(lblVallongitude))
						.addPreferredGap(ComponentPlacement.RELATED)
						.addGroup(gl_panel_1.createParallelGroup(Alignment.LEADING).addComponent(lblLatitude)
								.addComponent(lblVallatitude))
						.addPreferredGap(ComponentPlacement.RELATED)
						.addGroup(gl_panel_1.createParallelGroup(Alignment.BASELINE).addComponent(lblAltitude)
								.addComponent(lblValaltitude))
						.addPreferredGap(ComponentPlacement.RELATED)
						.addGroup(gl_panel_1.createParallelGroup(Alignment.LEADING).addComponent(lblVitesse)
								.addComponent(lblValvitesse))
						.addPreferredGap(ComponentPlacement.RELATED)
						.addGroup(gl_panel_1.createParallelGroup(Alignment.LEADING).addComponent(lblPrcision)
								.addComponent(lblValprecision))
						.addGap(18).addComponent(lblLastData).addPreferredGap(ComponentPlacement.RELATED)
						.addComponent(lblVallastdata).addContainerGap(58, Short.MAX_VALUE)));
