...
public class ContactPanel extends JPanel {
	...
	public ContactPanel(UserGUI gui) {
		...
		groupLayout.setVerticalGroup(groupLayout.createParallelGroup(Alignment.LEADING)
				.addGroup(groupLayout.createSequentialGroup().addContainerGap()
						.addComponent(splitPane, GroupLayout.DEFAULT_SIZE, 452, Short.MAX_VALUE).addGap(10)));
		...
		gl_panel.setHorizontalGroup(gl_panel.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_panel.createSequentialGroup().addContainerGap()
						.addGroup(gl_panel.createParallelGroup(Alignment.LEADING)
								.addComponent(txtrValaddr, GroupLayout.DEFAULT_SIZE, 197, Short.MAX_VALUE)
								.addComponent(btnMoreInformations, GroupLayout.DEFAULT_SIZE, 197, Short.MAX_VALUE)
								.addGroup(
										gl_panel.createSequentialGroup()
												.addComponent(btnCall, GroupLayout.DEFAULT_SIZE, 95, Short.MAX_VALUE)
												.addPreferredGap(ComponentPlacement.RELATED)
												.addComponent(btnSms, GroupLayout.DEFAULT_SIZE, 96, Short.MAX_VALUE))
								.addGroup(gl_panel.createSequentialGroup()
										.addGroup(gl_panel.createParallelGroup(Alignment.LEADING).addComponent(lblId)
												.addComponent(lblName).addComponent(lblNumber).addComponent(lblAddress))
										.addPreferredGap(ComponentPlacement.UNRELATED)
										.addGroup(gl_panel.createParallelGroup(Alignment.LEADING)
												.addComponent(lblValnumber).addComponent(lblValname).addComponent(
														lblValId)))
								.addGroup(gl_panel.createSequentialGroup().addComponent(lblEmail)
										.addPreferredGap(ComponentPlacement.UNRELATED).addComponent(lblValemail)))
						.addContainerGap()));
						...
						.addGroup(
								gl_panel.createSequentialGroup().addContainerGap()
										...
										.addGroup(gl_panel.createParallelGroup(Alignment.BASELINE)
												.addComponent(lblNumber).addComponent(lblValnumber))
										.addPreferredGap(ComponentPlacement.UNRELATED).addComponent(lblAddress)
										.addPreferredGap(ComponentPlacement.RELATED)
										.addComponent(txtrValaddr, GroupLayout.PREFERRED_SIZE, 42,
												GroupLayout.PREFERRED_SIZE)
										.addPreferredGap(ComponentPlacement.UNRELATED)
										.addGroup(gl_panel.createParallelGroup(Alignment.BASELINE)
												.addComponent(lblEmail).addComponent(lblValemail))
										.addPreferredGap(ComponentPlacement.RELATED, 191, Short.MAX_VALUE)
										.addComponent(btnMoreInformations).addPreferredGap(ComponentPlacement.RELATED)
										.addGroup(gl_panel.createParallelGroup(Alignment.BASELINE).addComponent(btnCall)
												.addComponent(btnSms))
										.addContainerGap()));
		...
		gl_panel_2.setHorizontalGroup(gl_panel_2.createParallelGroup(Alignment.TRAILING).addGroup(gl_panel_2
				...
				.addGroup(gl_panel_2.createParallelGroup(Alignment.LEADING)
						...
						.addComponent(panel_1, Alignment.TRAILING, GroupLayout.DEFAULT_SIZE, 219, Short.MAX_VALUE))
				.addContainerGap()));
			...
			if (contact.getDisplay_name() != null) {
				...
				if (im == null) {
					ImageIcon getImg = new ImageIcon(
							Toolkit.getDefaultToolkit().getImage(UserGUI.class.getResource("/gui/res/People.png")));
				...
				if (contact.getPhones() == null) {
					JLabel imgLabel = new JLabel(
							"no phone - " + contact.getDisplay_name() + " (id:" + contact.getId() + ")", imgResize,
							SwingConstants.LEFT);
					...
					JLabel imgLabel = new JLabel(contact.getPhones().get(0) + " - " + contact.getDisplay_name()
							+ " (id:" + contact.getId() + ")", imgResize, SwingConstants.LEFT);
					JPanel imgPanel = new JPanel(new FlowLayout(FlowLayout.LEFT));
					imgPanel.add(imgLabel);
