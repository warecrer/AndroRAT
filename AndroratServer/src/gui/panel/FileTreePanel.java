...
public class FileTreePanel extends JPanel {
	...
	public FileTreePanel(UserGUI gui) {
		...
		JLabel lblLeftclicToDownload = new JLabel("Left-clic to download a file :");
								...
								.addGroup(
										groupLayout.createSequentialGroup().addContainerGap()
												.addGroup(groupLayout.createParallelGroup(Alignment.LEADING)
														.addComponent(splitPane, GroupLayout.DEFAULT_SIZE, 533,
																Short.MAX_VALUE)
														.addComponent(lblLeftclicToDownload))
												.addContainerGap()));
		groupLayout.setVerticalGroup(groupLayout.createParallelGroup(Alignment.TRAILING).addGroup(Alignment.LEADING,
				groupLayout.createSequentialGroup().addContainerGap().addComponent(lblLeftclicToDownload)
						.addPreferredGap(ComponentPlacement.RELATED)
						.addComponent(splitPane, GroupLayout.DEFAULT_SIZE, 377, Short.MAX_VALUE).addContainerGap()));
				...
				.addGroup(gl_panel.createSequentialGroup().addContainerGap()
						.addGroup(gl_panel.createParallelGroup(Alignment.LEADING)
								...
								.addGroup(gl_panel.createSequentialGroup().addComponent(lblName)
										.addPreferredGap(ComponentPlacement.UNRELATED).addComponent(lblValname))
								.addGroup(gl_panel.createSequentialGroup().addComponent(lblSize)
										.addPreferredGap(ComponentPlacement.UNRELATED).addComponent(lblValsize))
								.addGroup(gl_panel.createSequentialGroup().addComponent(lblHidden)
										.addPreferredGap(ComponentPlacement.UNRELATED).addComponent(lblValhidden))
								.addGroup(gl_panel.createSequentialGroup().addComponent(lblAccess)
										.addPreferredGap(ComponentPlacement.UNRELATED).addComponent(lblValaccess))
								.addComponent(lblLastModification).addComponent(lblVallastmodif)
		...
		gl_panel.setVerticalGroup(gl_panel.createParallelGroup(Alignment.TRAILING)
				.addGroup(gl_panel.createSequentialGroup().addContainerGap()
						...
						.addGroup(gl_panel.createParallelGroup(Alignment.BASELINE).addComponent(lblSize)
								.addComponent(lblValsize))
						.addPreferredGap(ComponentPlacement.UNRELATED)
						.addGroup(gl_panel.createParallelGroup(Alignment.BASELINE).addComponent(lblHidden)
								.addComponent(lblValhidden))
						.addPreferredGap(ComponentPlacement.UNRELATED)
						.addGroup(gl_panel.createParallelGroup(Alignment.BASELINE).addComponent(lblAccess)
								.addComponent(lblValaccess))
						.addGap(32).addComponent(lblLastModification).addPreferredGap(ComponentPlacement.RELATED)
						.addComponent(lblVallastmodif).addPreferredGap(ComponentPlacement.RELATED, 77, Short.MAX_VALUE)
						.addComponent(lblDownloadDirectory).addPreferredGap(ComponentPlacement.RELATED)
						.addComponent(txtDir, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE,
								GroupLayout.PREFERRED_SIZE)
						.addPreferredGap(ComponentPlacement.RELATED).addComponent(btnDownload)
						.addPreferredGap(ComponentPlacement.RELATED).addComponent(btnTreeRequest).addContainerGap()));
		...
		if (e.getButton() == MouseEvent.BUTTON1) {
			...
			if (path != null) {
				...
				if (f != null) {
					...
					if (f.getLength() > 1024)
						sLength = String.valueOf(f.getLength()).substring(0, temp.length() - 3) + "Kb";
					else if (f.getLength() > 1024000)
						sLength = String.valueOf(f.getLength()).substring(0, temp.length() - 6) + "Mb";
					else if (f.getLength() > 1024000000)
						sLength = String.valueOf(f.getLength()).substring(0, temp.length() - 9) + "Tb";
					else
						sLength = temp + " bytes";
